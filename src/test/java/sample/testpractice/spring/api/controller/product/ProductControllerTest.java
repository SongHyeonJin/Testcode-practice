package sample.testpractice.spring.api.controller.product;
...
import sample.testpractice.spring.api.service.product.ProductService;
...
class ProductControllerTest {
    ...
    @DisplayName("신규 상품을 등록할 때 상품상태는 필수값이다.")
    @Test
